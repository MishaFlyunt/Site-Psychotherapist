const btnOff = document.querySelector(".scroll-off-1"); // Кнопка для вимкнення прокрутки
const btnOn = document.querySelector(".scroll-on-1"); // Кнопка для ввімкнення прокрутки
const btnOnData = document.querySelector("[data-modal-close-link]"); // Додатковий елемент для ввімкнення прокрутки
